...
\begin{figure}[H]
	\begin{centering}
		...
		\includegraphics[width=1.0\textwidth]{content/appendix/eudp/images/tb_r6.png}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Updated timebox figure}
		\includegraphics[width=1.0\textwidth]{content/appendix/eudp/images/project_scaling_tb6.jpg}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Updated timebox figure}
		\includegraphics[width=0.3\textwidth]{content/appendix/eudp/images/tb6_switchblock.eps}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Updated timebox figure}
		\includegraphics[width=0.5\textwidth]{content/appendix/eudp/images/tb6_bounce.png}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Updated timebox figure}
		\includegraphics[width=0.7\textwidth]{content/appendix/eudp/images/tb6_switch_FSD.eps}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Updated timebox figure}
		\includegraphics[width=1.0\textwidth]{content/appendix/eudp/images/tb6_switch_tb.png}
...
\begin{figure}[H]
	\begin{centering}
		...
		\includegraphics[width=1\textwidth]{content/appendix/eudp/images/tb6_webserver_savedata.png}
...
\begin{figure}[H]
	\begin{centering}
		...
		\includegraphics[width=1\textwidth]{content/appendix/eudp/images/tb6_webserver_sendcmd.png}
...
\begin{figure}[H]
	\begin{centering}
		%\missingfigure{Communication SendCmd.php}
		\includegraphics[width=0.8\textwidth]{content/appendix/eudp/images/tb6_webserver_saveip.png}
