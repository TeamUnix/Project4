...
\end{table}
As these tests cannot be performed, a minor test has been made in order to verify the functionality of the written device driver.
...
\p The interrupt input pin is tested by reading the pin when the FPGA is not yet interrupting to verify if it goes to sleep.
