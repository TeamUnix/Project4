...
\paragraph{Physical interface}
	The physical interface delivered for this time box is revision 0.01.5, this version can send data from switches and receive data to turn on and off the LEDs.
