...
\textbf{Ethernet} is made in software, and supported by the linux kernel. The embedded arm board have a dedicated IC to handle communication between ethernet and the CPU\\
